...
const CustomBtnWithIcon = ({
  ...
  return (
    <button
      className={`inline-flex h-12 gap-2 animate-shimmer ${bgColor} ${textColor} font-faculty items-center justify-center rounded-full border border-slate-800 bg-[linear-gradient(110deg,#000103,45%,#1e2631,55%,#000103)] bg-[length:200%_100%] px-6 font-medium transition-colors focus:outline-none focus:ring-0`}
      onClick={onClick}
    >
