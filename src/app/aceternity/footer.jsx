  ...
  return (
    <div className="h-[40rem] w-full rounded-none flex flex-col md:items-center md:justify-center bg-black/[0.96] antialiased bg-grid-white/[0.02] relative overflow-hidden">
      ...
      <div className="p-4 max-w-7xl mx-auto relative z-10 w-full pt-20 md:pt-0">
        ...
        Harness the power of AI to create stunning thumbnails effortlessly. Elevate your visuals and captivate your audience
        </p>
        ...
        <div className="flex flex-wrap justify-center mt-8 gap-20">
          ...
          <div className="mb-6 md:mb-0 text-center">
            <h3 className="text-lg font-semibold mb-2  text-neutral-300">Social</h3>
            <ul className="space-y- text-sm ">
              <li>
                <button onClick={() => window.open("https://x.com/Innovate_Hub_HQ", "_blank")} className="text-neutral-300 hover:underline">
                  X
                </button>
              </li>
              <li>
                <button onClick={() => window.open("https://discord.gg/xtYsPCCC", "_blank")} className="text-neutral-300 hover:underline">
                  Discord
                </button>
              </li>
            </ul>
